...
- **x86 / i386**: این معماری که به طور گسترده در کامپیوترهای رومیزی و لپ‌تاپ‌ها استفاده می‌شود، از پشتیبانی وسیع سیستم‌عامل‌ها و برنامه‌های کاربردی از جمله ویندوز، macOS، لینوکس، FreeBSD و OpenBSD برخوردار است.

- **armv8 / arm64 / aarch64**: این معماری برای دستگاه‌های مدرن موبایل، دسکتاپ و توکار (Apple Silicon M1/M2/M3/M4، Raspberry Pi 4/5، Orange Pi 3/5 و غیره) طراحی شده است.

- **armv7 / arm / arm32**: این معماری برای دستگاه‌های موبایل و توکار مانند Orange Pi Zero LTS، Orange Pi PC Plus، Raspberry Pi 2/3 و غیره کاربرد دارد.

- **armv6 / arm / arm32**: برای دستگاه‌های توکار کم‌مصرف (Raspberry Pi 1، Raspberry Pi Zero/Zero W).

- **armv5 / arm / arm32**: یک معماری قدیمی‌تر که عمدتاً با سیستم‌های توکار اولیه مرتبط است.

- **mips64 / mips64le / mips32 / mips32le**: معماری‌های MIPS برای روترها، تجهیزات شبکه (پلتفرم‌های OpenWrt/لینوکس توکار) و سرورها.

- **riscv64**: معماری ۶۴ بیتی متن‌باز RISC-V برای سخت‌افزارهای مدرن توکار و کامپیوترهای تک‌بردی (SiFive، Milk-V، StarFive).

- **ppc64 / ppc64le**: معماری ۶۴ بیتی PowerPC برای سرورهای سازمانی (سیستم‌های IBM Power).

- **s390x**: این معماری معمولاً در کامپیوترهای مین‌فریم IBM استفاده می‌شود و عملکرد و قابلیت اطمینان بالایی را ارائه می‌دهد.

- **loong64**: معماری ۶۴ بیتی LoongArch برای پلتفرم‌های Loongson.
