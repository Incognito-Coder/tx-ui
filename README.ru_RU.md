...
- **x86 / i386**: Широко используется в настольных и портативных компьютерах. Эта архитектура поддерживается множеством операционных систем, включая Windows, macOS, Linux, FreeBSD и OpenBSD.

- **armv8 / arm64 / aarch64**: Предназначена для современных мобильных, настольных и встроенных устройств (Apple Silicon M1/M2/M3/M4, Raspberry Pi 4/5, Orange Pi 3/5 и др.).

- **armv7 / arm / arm32**: Служит архитектурой для мобильных и встроенных устройств, таких как Orange Pi Zero LTS, Orange Pi PC Plus, Raspberry Pi 2/3 и других.

- **armv6 / arm / arm32**: Ориентирована на маломощные встроенные устройства (Raspberry Pi 1, Raspberry Pi Zero/Zero W).

- **armv5 / arm / arm32**: Более старая архитектура, ассоциируемая с ранними встроенными системами.

- **mips64 / mips64le / mips32 / mips32le**: Архитектуры MIPS для маршрутизаторов, сетевого оборудования (встроенные платформы OpenWrt/Linux) и корпоративных систем.

- **riscv64**: 64-битная открытая архитектура RISC-V для современного встроенного оборудования и одноплатных компьютеров (SiFive, Milk-V, StarFive).

- **ppc64 / ppc64le**: 64-битная архитектура PowerPC для корпоративных серверов (системы IBM Power).

- **s390x**: Эта архитектура обычно используется в мейнфреймах IBM и обеспечивает высокую производительность и надежность.

- **loong64**: 64-битная архитектура LoongArch для платформ Loongson.
...
- [API документация](https://www.postman.com/incognito-coder/tx-ui/collection/q1l5l0u/tx-ui)
...
панели [TX-UI Theming Hub](https://github.com/Incognito-Coder/TX-ThemeHub)
