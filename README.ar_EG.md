...
- **x86 / i386**: معتمدة على نطاق واسع في أجهزة الكمبيوتر المكتبية والمحمولة، وتدعم أنظمة Windows و macOS و Linux و FreeBSD و OpenBSD.

- **armv8 / arm64 / aarch64**: مصممة للأجهزة المحمولة والمكتبية والمدمجة الحديثة (Apple Silicon M1/M2/M3/M4، Raspberry Pi 4/5، Orange Pi 3/5، إلخ).

- **armv7 / arm / arm32**: تعمل كمعمارية للأجهزة المحمولة والمدمجة مثل Orange Pi Zero LTS و Orange Pi PC Plus و Raspberry Pi 2/3 وغيرها.

- **armv6 / arm / arm32**: موجهة للأجهزة المدمجة منخفضة الطاقة (Raspberry Pi 1، Raspberry Pi Zero/Zero W).

- **armv5 / arm / arm32**: معمارية أقدم مرتبطة بالأنظمة المدمجة القديمة.

- **mips64 / mips64le / mips32 / mips32le**: معماريات MIPS لأجهزة التوجيه (الراوتر)، وأجهزة الشبكات (منصات OpenWrt/Linux المدمجة) وخوادم المؤسسات.

- **riscv64**: معمارية 64-bit RISC-V المفتوحة للأجهزة المدمجة الحديثة وأجهزة الكمبيوتر أحادية اللوحة (SiFive, Milk-V, StarFive).

- **ppc64 / ppc64le**: معمارية 64-bit PowerPC لخوادم المؤسسات (أنظمة IBM Power).

- **s390x**: تُستخدم هذه المعمارية بشكل شائع في أجهزة الكمبيوتر المركزية من IBM وتوفر أداءً وموثوقية عالية.

- **loong64**: معمارية 64-bit LoongArch لـ منصات Loongson.
